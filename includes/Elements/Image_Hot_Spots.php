...
class Image_Hot_Spots extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
			...
			[
				'name'     => 'section_hotspots_typography',
                'exclude'  => [ 'font_size', 'line_height', 'word_spacing' ],
				'selector' => '{{WRAPPER}} .eael-hotspot-icon-wrap .eael-hotspot-text',
			]
		);

        $this->add_control(
			'section_hotspots_typography_notice',
			[
				'raw'             => __( 'Only Applicable for <br><strong>Content >> Hotspots >> Content >> Type:Text</strong>', 'essential-addons-elementor' ),
